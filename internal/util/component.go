...
func CopyComponentsAndLocalizeRefs(ctx context.Context, src libopenapi.Document, prefix string, dst libopenapi.Document) (nsrc libopenapi.Document, err error) {
	...
	for _, ref := range srcv3.Index.GetRawReferencesSequenced() {
		err = CopyComponentAndLocalizeRef(ctx, ref, prefix, dstv3.Model.Components)
	}
...
func CopyComponentAndLocalizeRef(
	ctx context.Context,
	src *index.Reference,
	prefix string,
	dst *v3.Components,
